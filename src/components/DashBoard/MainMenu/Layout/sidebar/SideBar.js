    ...
    <div className="side-menu">
      <Nav vertical className="list-unstyled pb-3 navi">
        ...
        <NavItem className="item_nav">
          <NavLink tag={Link} to={'/dashboard/home'} onClick={()=>{handleClick();}}>
        ...
        <NavItem className="item_nav">
          <NavLink tag={Link} to={'/dashboard/registration'} onClick={()=>{handleClick();}}>
        ...
        <NavItem className="item_nav">
          <NavLink tag={Link} to={'/dashboard/profile'} onClick={()=>{handleClick();}}>
        ...
        <NavItem className="item_nav">
          <NavLink tag={Link} to={'/logout'} onClick={()=>{handleClick();}}>
            {/* <FontAwesomeIcon icon={faImage} className="mr-2 icon_bar" /> */}
