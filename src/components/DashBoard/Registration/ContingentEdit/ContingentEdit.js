            ...
            <div className="text-justify">
              <h2>
                ...
                <table align="center" cellpadding="20" className="profile-table">
                                        <tr>
                                            <td className="left-column" style={{textAlign: 'left'}}>Total Number of Boys : </td>
                                        ...
                                        <tr>
                                            <td className="left-column" style={{textAlign: 'left'}}>Total Number of Girls : </td>
                                            <td className="right-column" width="30%">
                                              <FormGroup>                                                
                                                    <Input 
                                                    type="number" 
                                        ...
                                        <tr>
                                              <td className="left-column" style={{textAlign: 'left'}}>Total Number of officials accompanying the contingent : </td>
                                              <td className="right-column" width="30%">
                                              <FormGroup>                                                
                                                    <Input 
                                                    type="number" 
                                        ...
                                        <tr>
                                            <td className="left-column" style={{textAlign: 'left'}}>Full Name of Contingent Leader <span style={{color: 'red'}}>*</span> :  </td>
                                            <td className="right-column" width="30%">
                                              <FormGroup>                                                
                                                    <Input 
                                                    type="text" 
                                        ...
                                        <tr>
                                            <td className="left-column" style={{textAlign: 'left'}}>Contact Number of Contingent Leader <span style={{color: "red"}}>*</span> :  </td>
                                            <td className="right-column" width="30%">
                                              <FormGroup>                                                
                                                    <Input 
                                                    type="text" 
                                        ...
                                        <tr>
                                            ...
                                            <td className="right-column" style={{color: 'red', fontSize: '15px'}}><div id="error-reg-edit"></div></td>
                                        </tr>
                                        </table>
                </Form>
                        <table align="center" cellpadding="20" className="profile-table">
                                            <tr className="mine_contDb">
                                                    <td ><button onClick={cancelButton} className="register-now" style={{marginRight: '0'}}>Cancel</button></td>
                                                    <td > <button onClick={submitButton} className="register-now">Submit</button></td>
                                            </tr>
                        </table>
              </h2>
            </div>
