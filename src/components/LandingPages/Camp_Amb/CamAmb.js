...
const CamAmb = () => {
  return (
    <section className={`${styles.ftco_section_services}`} id={`${styles.ca}`}>
            ...
            >
              <div className={`${styles.text_justify}`}>
                ...
                >
                  ...
                  integral part of the organizing team of Spardha'19. We extend
                  our welcome to all passionate individuals who would be working
                  together with us and leading the contingents taking part in
                  the festival from their respective colleges.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className={`${styles.block_71} ${styles.block3}`}>
              <div className={`${styles.text_justify}`}>
                ...
                >
                  ...
                  test of your managerial and leadership skills by being a face
                  of Spardha '19 in your college.&nbsp;
                  <br />
                  <br />
                </p>
              </div>
              ...
              <div className={`${styles.text_justify}`}>
                ...
                >
                  <ol>
                    ...
                    <li>
                      BRAINSTORM - The applicant would be working with the team
                      to come up with fresh ideas together to make this edition
                      of Spardha splendorous.
                    </li>
                  </ol>
                </p>
              </div>
              ...
              <div className={`${styles.text_justify}`}>
                ...
                >
                  <ol>
                    ...
                    <li>Indelible opportunity to meet the esteemed guests.</li>
            ...
            <div className={`${styles.block_71} ${styles.block6}`}>
              <div className={`${styles.text_justify}`}>
                <h3 className={`${styles.ca_heading}`}>
                  ...
                  />
                  <p className={`${styles.ca_heading2}`}>&ensp; Eligibility</p>
                </h3>
                <p
                  style={{
                    color: '#808080',
                ...
                >
                  Applicants from all streams are welcome. Academic year is not
                  a restriction, anyone who possess the zeal and dedication for
                  Spardha'19 are eligible to apply.
                  <br />
                  <br />
                </p>
              </div>
            ...
            <div className={`${styles.block_71}`} style={{ padding: '22px' }}>
              <div className={`${styles.text_justify}`}>
                <h3 className={`${styles.ca_heading}`}>
                  ...
                  />
                  <p className={`${styles.ca_heading2}`}>&ensp; What Next ? </p>
                </h3>
