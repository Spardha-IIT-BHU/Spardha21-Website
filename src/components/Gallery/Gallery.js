    ...
    <section id="gallery" className="ftco-section">
        <div className="container_gallery gallery-container mb-5 pt-1">
            ...
            <div className="tz-gallery">
                <div className="row_gallery mb-3 gallery-heading boldClass" style={{fontSize: "22px"}}>
                    Opening Ceremony:
                </div>
                ...
                <div className="row_gallery mb-3 mt-3 gallery-heading boldClass" style={{fontSize: "22px"}}>
                    Pre-Events:
                </div>
